...
import com. library.online_library.service.BookServiceImpl;
import com. library.online_library.utill.StoreUtil;
    ...
    public void service(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try {
            if (req.getParameter("updateFormSubmitted") != null) {
                String bName = req.getParameter(BooksDatabaseConstants.COLUMN_NAME);
                String bCode = req.getParameter(BooksDatabaseConstants.COLUMN_BARCODE);
                String bAuthor = req.getParameter(BooksDatabaseConstants.COLUMN_AUTHOR);
                double bPrice = Double.parseDouble(req.getParameter(BooksDatabaseConstants.COLUMN_PRICE));
                int bQty = Integer.parseInt(req.getParameter(BooksDatabaseConstants.COLUMN_QUANTITY));
