...
public class UserServiceImpl implements UserService {
    ...
    private static final String registerUserQuery = "INSERT INTO " + UsersDatabaseConstants.TABLE_USERS
            + "  VALUES(?,?,?,?,?,?,?,?)";

    private static final String loginUserQuery = "SELECT * FROM " + UsersDatabaseConstants.TABLE_USERS + " WHERE "
            + UsersDatabaseConstants.COLUMN_USERNAME + "=? AND " + UsersDatabaseConstants.COLUMN_PASSWORD + "=? AND "
            + UsersDatabaseConstants.COLUMN_USERTYPE + "=?";
